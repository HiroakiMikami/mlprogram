...
from nl2prog.dataset.deepcoder.dsl \
    import Function, Type, Variable, Expression, Program, Signature, Statement
from nl2prog.dataset.deepcoder.program_simplifier \
    import normalize, remove_redundant_variables, \
    remove_redundant_expressions, remove_dependency_between_variables
...
class Test_program_simplifier(unittest.TestCase):
    def test_normalize(self):
        ...
        p = Program([Variable(2, Type.Int), Variable(0, Type.IntList)], [
                    Statement(Variable(3, Type.Int),
                              Expression(F, [Variable(2, Type.Int)]))])
        p = normalize(p)
        self.assertEqual(
            p,
            Program([Variable(0, Type.IntList), Variable(1, Type.Int)], [
                    Statement(Variable(2, Type.Int),
                              Expression(F, [Variable(1, Type.Int)]))])
        )
    ...
    def test_remove_redundant_variables(self):
        ...
        p = Program([Variable(0, Type.Int), Variable(1, Type.IntList)], [
                    Statement(Variable(2, Type.Int),
                              Expression(F, [Variable(0, Type.Int)]))])
        p = remove_redundant_variables(p)
        self.assertEqual(
            p,
        ...
        p = Program([Variable(0, Type.Int)],
                    [Statement(Variable(1, Type.Int),
                               Expression(F, [Variable(0, Type.Int)])),
                     Statement(Variable(2, Type.Int),
                               Expression(F, [Variable(0, Type.Int)]))])
        p = remove_redundant_variables(p)
    ...
    def test_remove_redundant_expressions(self):
        ...
        p = Program([Variable(0, Type.IntList)], [
                    Statement(Variable(1, Type.Int),
                              Expression(F, [Variable(0, Type.IntList)]))])
